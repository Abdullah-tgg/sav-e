  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image source={require('../../assets/img/Onboarding2.png')} style={styles.onboardingImage} />
      </View>

      {/* Main Text */}
      <Text style={styles.mainText}>Stay Ahead of Trends</Text>

      {/* Sub Text */}
      <Text style={styles.subText}>Get Exclusive Access to the Latest Styles!
      </Text>
